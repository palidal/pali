...
<script>
	...
	*/
	function preview() {
		...
		dialogContent+= '<link href="<?php echo base_url(); ?>js/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">\n';
		dialogContent+='<style>\n'+$("#content-styles").html()+'\n</style>\n';
		dialogContent+= '</head>\n<body>';
...
<body>
	...
	<![endif]-->
  <center><legend>Formulario Din&aacute;mico</legend></center>
  <div class="tabbable"> 
...
<script type="text/javascript" src="<?php echo base_url(); ?>js/libs/bootstrap/js/jquery.js"></script>	
<script type="text/javascript" src="<?php echo base_url(); ?>js/libs/bootstrap/js/bootstrap.min.js"></script>


<script type="text/javascript" src="<?php echo base_url(); ?>js/libs/jqueryui/ui/minified/jquery-ui.min.js"></script>
...
Uso:
  <ul>
	  <li>Arrastrar los elementos que se encuentran a la izquierda.</li>
	  <li>Personalizar los elementos haciendo clic.</li>
	  <li>Hacer clic en Preview para ver el renderizado del formulario y su correspondiente código.</li>
  </ul>
</h6>
<hr/>
</body>
